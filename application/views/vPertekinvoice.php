...
<script src="<?php echo base_url(); ?>assets/js/vPertekinvoice.js"></script>
    	...
    	<div class="col-xs-12">
			...
			<div class="box">
				<div class="box-header with-border">
                    ...
                    <input type="hidden" class="form-control uppercase"  readonly id="txt_idsub" value="<?php echo $pertekdt1['id_sub'];?>"/>
                    <input type="hidden" class="form-control uppercase"  readonly id="kd_kategori" value="<?php echo $pertekdt1['kd_kategori'];?>"/>
				</div>
				<div class="box-body">
					<div class="row">
                        <div class="col-md-5">
			...
			<div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title"><?php echo $titleinvoice;?></h3>
				</div>
				<table id="tb_listinvoice" class="table table-bordered">
                    <thead>
                        <tr>
                            <th style="text-align:center">No Invoice</th>
                            <th style="text-align:center">Tgl Invoice</th>
                            <th style="text-align:center">Supplier</th>
                            <th style="text-align:center">Partno</th>
