...
<script src="<?php echo base_url(); ?>assets/js/vpertekdt1.js"></script>
    	...
    	<div class="col-xs-12">
			<div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">PERTEK NO <b><?php echo $nopertekHD['nopertek'].' (status : '.$nopertekHD['status'].')'; ?></b></h3>
				  <div class="box-tools">
						<div class="btn-group pull-left">
								<button type="button" class="btn btn-sm btn-default" onclick="BacktoPertek()">
				...
				<div class="box-body">
					<div class="row">
						<input type="hidden" id="txt_idpertek" hidden="true" value="<?php echo $nopertekHD['idpertek']?>">
										</div>
