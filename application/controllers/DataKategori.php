			...
			for($i = $iDisplayStart; $i < $end; $i++)
				{
					...
					{
						$act = '- || <a class="btn btn-info alert-info btn-xs fa-edit " href="#" onclick="editKeluar(\''.$data[$i]->kd_kategori.'\')"><i class="fa fa-fw fa-edit"></i>Ubah</a>';
					}
					else
					{
						$act = '<a class="btn btn-danger alert-danger btn-xs" href="'.base_url().'DataKategori/delete_kategori/'.$data[$i]->kd_kategori.'"
						onclick="return confirm(\'anda yakin akan Hapus '.$data[$i]->kd_kategori.'?\')"><i class="fa fa-fw fa-trash"></i>Hapus</a> ||
						<a class="btn btn-info alert-info btn-xs  " href="#" onclick="editKeluar(\''.$data[$i]->kd_kategori.'\')"><i class="fa fa-fw fa-edit"></i>Ubah</a>';
					}
// print $privilege;
					$records["data"][] = array(
					$data[$i]->kd_kategori,
